...
namespace GiaoDien
{
    public partial class CTHD : Form
    {
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            if (txtMahd.Text == "" || txtmanv.Text == "" || txtchietkhau.Text == "")
            {
                ...
                return;
                  ...
                  hd.TONGTIEN = 0;
                  if (rdb_khtt.Checked == true)
                  {
                      txt_kvl.Enabled = false;
        ...
        private void hOADONBANDataGridView_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void fill_hdToolStripButton_Click(object sender, EventArgs e)
        {
